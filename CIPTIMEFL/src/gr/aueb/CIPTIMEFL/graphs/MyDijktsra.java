 ...
 */
public class MyDijktsra implements PathFinder<WeightedPath>
{
     ...
     */
    public MyDijktsra( PathExpander expander, CostEvaluator<Double> costEvaluator )
    {
        this( expander, costEvaluator, PathInterestFactory.allShortest( NoneStrictMath.EPSILON ) );
    }


    public MyDijktsra( PathExpander expander, CostEvaluator<Double> costEvaluator, PathInterest<Double> interest )
    {
     ...
     */
    public MyDijktsra( PathExpander expander, CostEvaluator<Double> costEvaluator, double epsilon,
